...
<meta charset="utf-8">
		...
		<div class="col-xl-auto dropdownButton">
			...
			<div class="dropdown-menu " aria-labelledby="asdf">
				...
				<button class="dropdown-item color"><a href="chrisPage.php">Chris Dahrens</a></button>
				<button class="dropdown-item color"><a href="Matt'sPage.php">Matt Marquart</a></button>
